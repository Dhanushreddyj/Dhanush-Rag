...
Cline may generate and edit only the implementation and test code listed below. All governance documents and workspace rules are read-only.
...
- Give every concrete exception a unique stable code and safe default message.
